...
const StoreOrderList: React.FC<StoreOrderListProps> = ({ orders }) => {
  ...
  return (
    <div className="bg-surface border border-border rounded-lg shadow-sm">
      <div className="p-4 border-b border-border">
        <h3 className="text-lg font-semibold text-text-primary">Store Orders</h3>
        <input
          type="text"
          placeholder="Search this store's orders..."
          value={searchTerm}
